...
namespace data_structure_project_record_company {
	public partial class Search : Form {
		...
		private void searchButton_Click(object sender, EventArgs e) {
			...
			if (codeField.Text == "")
				erro += "- O campo de código não pode ser nulo\n";
			...
			switch (tipoBusca.SelectedIndex){
				...
				case 2:
					...
					if (binarySearchResult != -1) {
						...
						banda1 = artistaTemp1.BandaBool ? "Sim" : "Não";
						dataGridView1.Rows.Add(artistaTemp1.Codigo, artistaTemp1.NomeVerdadeiro, artistaTemp1.NomeArtistico, artistaTemp1.Aniversario.ToString("d"), banda1, "Compositor");

						General.Artista artistaTemp2 = General.Artistas[General.Cancoes[binarySearchResult].CodigoArtistaPrimeiraGravacao - 1];
						banda2 = artistaTemp2.BandaBool ? "Sim" : "Não";
						dataGridView1.Rows.Add(artistaTemp2.Codigo, artistaTemp2.NomeVerdadeiro, artistaTemp2.NomeArtistico, artistaTemp2.Aniversario.ToString("d"), banda2, "Musicista");
